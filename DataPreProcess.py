...
# merged_df = pd.merge(df1_imputed, df2_imputed, on='id', how='left')
# merged_df = pd.merge(df1_imputed, df2_imputed, on='id', how='right')
# merged_df = pd.merge(df1_imputed, df2_imputed, on='id', how='outer')
